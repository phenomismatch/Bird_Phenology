...
save(hex7_mcd12Q2, file = paste0('/Users/', user, '/Dropbox/Work/Phenomismatch/Veg_phenology/Data_products/hex7_mcd12Q2.Rdata'))
...
save(hex6_mcd12Q2, file = paste0('/Users/', user, '/Dropbox/Work/Phenomismatch/Veg_phenology/Data_products/hex6_mcd12Q2.Rdata'))
