...
#SBATCH -o /UCHC/LABS/Tingley/phenomismatch/Bird_Phenology/Data/Processed/halfmax_juvs_2019-08-21/hm-juvs-Geothlypis_trichas.out #STDOUT
#SBATCH -e /UCHC/LABS/Tingley/phenomismatch/Bird_Phenology/Data/Processed/halfmax_juvs_2019-08-21/hm-juvs-Geothlypis_trichas.err #STDERR
