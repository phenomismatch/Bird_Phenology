...
setwd(paste0(dir, 'Bird_Phenology/Data/Processed/br_arr_', bp_date))
saveRDS(fit, file = paste0('br-arr-bp-stan-output-', bp_date, '.rds'))
...
sink(paste0('br-arr-bp-stan-results-', bp_date, '.txt'))
...
MCMCvis::MCMCtrace(fit,
                   ...
                   priors = PR,
                   pdf = TRUE,
                   filename = paste0('br-arr-bp-', bp_date, '-trace_mu_alpha.pdf'))
...
MCMCvis::MCMCtrace(fit,
                   ...
                   priors = PR,
                   pdf = TRUE,
                   filename = paste0('br-arr-bp-', bp_date, '-trace_mu_beta.pdf'))
...
MCMCvis::MCMCtrace(fit,
                   ...
                   priors = PR,
                   pdf = TRUE,
                   filename = paste0('br-arr-bp-', bp_date, '-trace_sigma_sp[1].pdf'))
...
MCMCvis::MCMCtrace(fit,
                   ...
                   priors = PR,
                   pdf = TRUE,
                   filename = paste0('br-arr-bp-', bp_date, '-trace_sigma_sp[2].pdf'))
...
MCMCvis::MCMCtrace(fit,
                   ...
                   priors = PR,
                   pdf = TRUE,
                   filename = paste0('br-arr-bp-', bp_date, '-trace_mu_bp.pdf'))
