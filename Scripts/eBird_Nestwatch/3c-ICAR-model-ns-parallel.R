######################
# 3c - ICAR model with both spatial and non-spatial components in parallel
#
# Same as 3b-ICAR-model-ns.R, except run in parallel. May not be necessary to use foreach package to parallelize?
#
# Formerly NA_birdPhen2_parallel.R
######################
