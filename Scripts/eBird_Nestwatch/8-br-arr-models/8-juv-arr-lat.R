######################
# 8 - juv hitting nets ~ arrival + lat + arrival x lat
#
######################
...
# base R model selection --------------------------------------------------

fit1 <- lm(juv_mean ~ mean_post_IAR, data = mrg_f2)
fit2 <- lm(juv_mean ~ cell_lat, data = mrg_f2)
fit3 <- lm(juv_mean ~ mean_post_IAR * cell_lat, data = mrg_f2)
fit4 <- lm(juv_mean ~ mean_post_IAR + cell_lat, data = mrg_f2)
fit5 <- lm(juv_mean ~ mean_post_IAR + mean_post_IAR * cell_lat, data = mrg_f2)
fit6 <- lm(juv_mean ~ cell_lat + mean_post_IAR * cell_lat, data = mrg_f2)
fit7 <- lm(juv_mean ~ mean_post_IAR + cell_lat + mean_post_IAR * cell_lat, data = mrg_f2)
...
aic_vec <- c(aic1, aic2, aic4, aic4, aic5, aic6, aic7)
...
setwd(paste0(dir, 'Bird_Phenology/Data/Processed/br_arr_', juv_date))
saveRDS(fit, file = paste0('juv-arr-lat-stan-output-', juv_date, '.rds'))
...
sink(paste0('juv-arr-lat-stan-results-', juv_date, '.txt'))
...
MCMCvis::MCMCtrace(fit,
                   ...
                   priors = PR,
                   pdf = TRUE,
                   filename = paste0('juv-arr-lat-', juv_date, '-trace_mu_alpha.pdf'))
...
MCMCvis::MCMCtrace(fit,
                   ...
                   priors = PR,
                   pdf = TRUE,
                   filename = paste0('juv-arr-lat-', juv_date, '-trace_mu_beta.pdf'))
...
MCMCvis::MCMCtrace(fit,
                   ...
                   priors = PR,
                   pdf = TRUE,
                   filename = paste0('juv-arr-lat-', juv_date, '-trace_sigma_sp[1].pdf'))
...
MCMCvis::MCMCtrace(fit,
                   ...
                   priors = PR,
                   pdf = TRUE,
                   filename = paste0('juv-arr-lat-', juv_date, '-trace_sigma_sp[2].pdf'))
...
MCMCvis::MCMCtrace(fit,
                   ...
                   priors = PR,
                   pdf = TRUE,
                   filename = paste0('juv-arr-lat-', juv_date, '-trace_sigma.pdf'))
...
MCMCvis::MCMCtrace(fit,
                   ...
                   priors = PR,
                   pdf = TRUE,
                   filename = paste0('juv-arr-lat-', juv_date, '-trace_mu_juv.pdf'))
