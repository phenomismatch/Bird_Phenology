...
Investigate changes in wing chord over the lifespan of birds.
...
Run paired two-tailed t-test for each species that had measurements for more than 20 individuals (to test difference in wing_chord between Age 1 and Age 2+ age classes). Estimated difference and corrected p-values returned for each species. There are likely better ways to analyze these data, but this was relatively straightforward and easy.


### Results

Wing chord increase from Age 1 (Second Year) to Age 2+ (Third Year+). This holds true across most species analyzed.
