...
#SBATCH -o /labs/Tingley/phenomismatch/Bird_Phenology/Data/Processed/juv_trends_output_$DATE/$temp-jt.out #STDOUT
#SBATCH -e /labs/Tingley/phenomismatch/Bird_Phenology/Data/Processed/juv_trends_output_$DATE/$temp-jt.err #STDERR
