...
singularity exec -B /UCHC /isg/shared/apps/R/3.5.2/R.sif /UCHC/LABS/Tingley/phenomismatch/Bird_Phenology/Scripts/eBird_Nestwatch/4-IAR/4-IAR-model.R Setophaga_fusca
