...
singularity exec -B /UCHC /isg/shared/apps/R/3.5.2/R.sif /home/CAM/cyoungflesh/phenomismatch/Bird_Phenology/Scripts/eBird_Nestwatch/4-IAR/4-IAR-model.R Sialia_sialis
