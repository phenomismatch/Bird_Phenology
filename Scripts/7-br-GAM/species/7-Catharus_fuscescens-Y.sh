...
#$ -o br-gam-Catharus_fuscescens-Y.joblog               #jobname
...
/usr/bin/time -apv Rscript /u/home/c/cyoungfl/Bird_Phenology/Scripts/7-br-GAM/7-br-GAM.R Catharus_fuscescens Y
