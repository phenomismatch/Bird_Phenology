...
#$ -o br-gam-Oreothlypis_ruficapilla-Y.joblog               #jobname
...
/usr/bin/time -apv Rscript /u/home/c/cyoungfl/Bird_Phenology/Scripts/7-br-GAM/7-br-GAM.R Oreothlypis_ruficapilla Y
