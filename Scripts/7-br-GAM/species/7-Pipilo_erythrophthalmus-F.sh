...
#$ -o br-gam-Pipilo_erythrophthalmus-F.joblog               #jobname
...
/usr/bin/time -apv Rscript /u/home/c/cyoungfl/Bird_Phenology/Scripts/7-br-GAM/7-br-GAM.R Pipilo_erythrophthalmus F
