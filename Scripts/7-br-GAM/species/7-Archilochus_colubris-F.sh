...
#$ -o br-gam-Archilochus_colubris-F.joblog               #jobname
...
/usr/bin/time -apv Rscript /u/home/c/cyoungfl/Bird_Phenology/Scripts/7-br-GAM/7-br-GAM.R Archilochus_colubris F
