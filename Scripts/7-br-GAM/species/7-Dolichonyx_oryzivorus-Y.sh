...
#$ -o br-gam-Dolichonyx_oryzivorus-Y.joblog               #jobname
...
/usr/bin/time -apv Rscript /u/home/c/cyoungfl/Bird_Phenology/Scripts/7-br-GAM/7-br-GAM.R Dolichonyx_oryzivorus Y
