...
#$ -o br-gam-Pheucticus_ludovicianus-Y.joblog               #jobname
...
/usr/bin/time -apv Rscript /u/home/c/cyoungfl/Bird_Phenology/Scripts/7-br-GAM/7-br-GAM.R Pheucticus_ludovicianus Y
