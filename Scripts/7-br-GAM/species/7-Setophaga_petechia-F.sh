...
#$ -o br-gam-Setophaga_petechia-F.joblog               #jobname
...
/usr/bin/time -apv Rscript /u/home/c/cyoungfl/Bird_Phenology/Scripts/7-br-GAM/7-br-GAM.R Setophaga_petechia F
