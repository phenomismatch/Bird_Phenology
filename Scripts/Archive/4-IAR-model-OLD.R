...
#
# 
# THIS IS THE COMBINED SPATIAL/NON-SPATIAL MODEL- DEPRECATED
...
IAR_out_dir <- 'IAR_output_2019-02-10'
...
#beta0[j] ~ normal(120, 5)
#mu_beta1 ~ normal(1.5, 1)
#sigma_beta1 ~ halfnormal(0, 2)
#rho ~ beta(0.5, 0.5);
#sigma ~ halfnormal(2, 3);


#beta0
PR <- rnorm(10000, 120, 5)
