...
#SBATCH --job-name=2020-02-10-Contopus_virens
...
#SBATCH -o /labs/Tingley/phenomismatch/Bird_Phenology/Data/Processed/IAR_output_2020-02-10/Contopus_virens-iar.out #STDOUT
#SBATCH -e /labs/Tingley/phenomismatch/Bird_Phenology/Data/Processed/IAR_output_2020-02-10/Contopus_virens-iar.err #STDERR
