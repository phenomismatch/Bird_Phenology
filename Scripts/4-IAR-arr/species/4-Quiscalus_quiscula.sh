...
#SBATCH --job-name=2020-02-10-Quiscalus_quiscula
...
#SBATCH -o /labs/Tingley/phenomismatch/Bird_Phenology/Data/Processed/IAR_output_2020-02-10/Quiscalus_quiscula-iar.out #STDOUT
#SBATCH -e /labs/Tingley/phenomismatch/Bird_Phenology/Data/Processed/IAR_output_2020-02-10/Quiscalus_quiscula-iar.err #STDERR
