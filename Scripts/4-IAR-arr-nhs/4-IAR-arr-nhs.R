######################
# 4 - IAR model - NO HIERARCHICAL SIGMA NU
#
# Fit IAR model
#
# VVV MODEL VVV
...
for (i in 1:N)
{
  ...
  y_true[i] = beta0[i] + gamma + nu[i] * sigma_nu;
...
MCMCvis::MCMCtrace(fit,
                   ...
                   priors = PR,
                   open_pdf = FALSE,
                   filename = paste0(args, '-trace-sigma_nu-', IAR_out_date, '.pdf'))
