...
#SBATCH -o /labs/Tingley/phenomismatch/Bird_Phenology/Data/Processed/halfmax_arrival_2020-05-07/hm-arr-Catharus_bicknelli.out #STDOUT
#SBATCH -e /labs/Tingley/phenomismatch/Bird_Phenology/Data/Processed/halfmax_arrival_2020-05-07/hm-arr-Catharus_bicknelli.err #STDERR
